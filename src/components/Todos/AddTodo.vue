...
<template>
  <input
    ...
    autocomplete="off"
    required
    class="relative block w-full appearance-none rounded-2xl border-gray-200 font-medium text-md shadow-sm px-6 py-4 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-400 focus:border-2 focus:outline-none focus:ring-0"
